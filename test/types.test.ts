...
import type { OctopusConsumptionCardConfig, ConsumptionDataPoint, ComparisonResult } from '../src/types';

describe('Type Definitions', () => {
  describe('OctopusConsumptionCardConfig', () => {
    it('accepts valid configuration', () => {
      const config: OctopusConsumptionCardConfig = {
    ...
    it('allows optional fields', () => {
      const minimalConfig: OctopusConsumptionCardConfig = {
        type: 'custom:octopus-consumption-card',
        entity: 'sensor.octopus_energy_es_test_daily_consumption',
      };
    ...
    it('accepts valid period values', () => {
      const configDay: OctopusConsumptionCardConfig = {
        type: 'custom:octopus-consumption-card',
        entity: 'sensor.octopus_energy_es_test_daily_consumption',
        default_period: 'day',
      };
      
      const configWeek: OctopusConsumptionCardConfig = {
        type: 'custom:octopus-consumption-card',
        entity: 'sensor.octopus_energy_es_test_daily_consumption',
        default_period: 'week',
      };
      
      const configMonth: OctopusConsumptionCardConfig = {
        type: 'custom:octopus-consumption-card',
        entity: 'sensor.octopus_energy_es_test_daily_consumption',
    ...
    it('accepts valid chart types', () => {
      const configLine: OctopusConsumptionCardConfig = {
        type: 'custom:octopus-consumption-card',
        entity: 'sensor.octopus_energy_es_test_daily_consumption',
        chart_type: 'line',
      };
      
      const configBar: OctopusConsumptionCardConfig = {
        type: 'custom:octopus-consumption-card',
        entity: 'sensor.octopus_energy_es_test_daily_consumption',
        chart_type: 'bar',
      };
