...
export const translations: Record<string, Translations> = {
  en: {
    ...
    "card.week_comparison.base_week": "Base Week",
    ...
    "card.week_comparison.period": "Period",
    "card.week_comparison.comparison_disabled": "N/A",
    "card.week_comparison.comparison_disabled_tooltip": "Comparison not available for incomplete weeks",
  ...
  es: {
    ...
    "card.week_comparison.base_week": "Semana Base",
    ...
    "card.week_comparison.period": "Período",
    "card.week_comparison.comparison_disabled": "N/D",
    "card.week_comparison.comparison_disabled_tooltip": "Comparación no disponible para semanas incompletas",
  ...
  be: {
    ...
    "card.week_comparison.base_week": "Базавы тыдзень",
    ...
    "card.week_comparison.period": "Перыяд",
    "card.week_comparison.comparison_disabled": "Н/Д",
    "card.week_comparison.comparison_disabled_tooltip": "Параўнанне недаступна для незавершаных тыдняў",
