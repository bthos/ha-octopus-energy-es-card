    ...
    `}_renderWeekComparison(){const t=this.hass?.language||"en";if(!this._weekComparisonData||0===this._weekComparisonData.weeks.length)return W`<div class="loading">${ft("card.week_comparison.no_data",t)}</div>`;const{weeks:e,comparisons:r}=this._weekComparisonData;return W`
      <div class="week-comparison-section">
        <div class="week-comparison-grid">
          ${e.map((e,n)=>{const i=r.find(t=>t.weekIndex===n),a=0===n?ft("card.week_comparison.base_week",t):`Week -${n}`,o=!e.isComplete;let s=0,c=0;if(o&&e.daysCount>0){s=7*(e.consumption/e.daysCount),c=7*(e.cost/e.daysCount)}return W`
              <div class="week-card ${o?"week-card-incomplete":""}">
                <div class="week-card-header">
                  ...
                  `:i&&o?W`
                    <span class="week-change-disabled" title="${ft("card.week_comparison.comparison_disabled_tooltip",t)}">
                      ${ft("card.week_comparison.comparison_disabled",t)}
                    </span>
                  `:""}
                </div>
                <div class="week-card-metrics">
                  ...
                  <div class="week-metric">
                    ...
                    <span class="week-metric-value">
                      ${e.consumption.toFixed(1)} kWh
                      ${o&&s>0?W`
                        <span class="week-forecast">(${ft("card.week_comparison.forecast",t)}: ${s.toFixed(1)} kWh)</span>
                      `:""}
                    </span>
                  </div>
                  <div class="week-metric">
                    ...
                    <span class="week-metric-value">
                      €${e.cost.toFixed(2)}
                      ${o&&c>0?W`
                        <span class="week-forecast">(${ft("card.week_comparison.forecast",t)}: €${c.toFixed(2)})</span>
                      `:""}
                    </span>
                  </div>
                  <div class="week-metric">
                    <span class="week-metric-label">${ft("card.week_comparison.period",t)}:</span>
