...
/**
    ...
    `}}ge.enabledWarnings=[],ge.styles=s`
    .card-config {
      padding: 16px;
    }
  ...
  `,fe([pe({attribute:!1})],ge.prototype,"hass",void 0),fe([pe({attribute:!1})],ge.prototype,"config",void 0),fe([he()],ge.prototype,"_config",void 0),"undefined"!=typeof window&&"undefined"!=typeof customElements&&(customElements.get("octopus-consumption-card-editor")||customElements.define("octopus-consumption-card-editor",ge));class me{static info(e,...t){const r=[e,this.STYLES.info];t.forEach((e,t)=>{r.push(e,t%2==0?this.STYLES.infoValue:this.STYLES.info)}),console.log(...r)}static error(e,t){t?console.error(`%c${e}%c${t}`,this.STYLES.error,this.STYLES.errorValue):console.error(`%c${e}`,this.STYLES.error)}static warn(e,t){t?console.warn(`%c${e}%c${t}`,this.STYLES.warning,this.STYLES.warningValue):console.warn(`%c${e}`,this.STYLES.warning)}static success(e){console.log(`%c${e}`,this.STYLES.success)}static data(e,t){console.log(`%c  ${e}: %c${JSON.stringify(t,null,2)}`,this.STYLES.info,this.STYLES.infoValue)}static serviceCall(e,t,r=!1){this.info("  Calling service: ",`${e}.${t}${r?" (with return_response)":""}`)}static serviceData(e){this.data("Service data",e)}static serviceResponse(e){this.data("Raw Service Response",e)}static serviceError(e){console.error("%c  Service Error Details: %c"+JSON.stringify(e,Object.getOwnPropertyNames(e),2),this.STYLES.info,this.STYLES.errorValue)}static groupServiceCall(e,t){console.groupCollapsed(`%c🔧 Service Call: %c${e}.${t}`,this.STYLES.info,this.STYLES.infoValue)}static groupEnd(){console.groupEnd()}static groupDataLoad(e,t,r){console.groupCollapsed(`%c📊 Loading Data: %cEntry: ${e} | Period: ${t} | ${r}`,this.STYLES.info,this.STYLES.infoValue)}static groupError(e){console.groupCollapsed(`%c❌ ${e}`,this.STYLES.error)}}me.STYLES={info:"color: #666; font-size: 11px;",infoValue:"color: #999; font-size: 11px; font-family: monospace;",error:"color: #f00; font-size: 11px; font-weight: bold;",errorValue:"color: #f00; font-size: 11px;",warning:"color: #ff9800; font-size: 11px;",warningValue:"color: #ff9800; font-size: 11px;",success:"color: #4caf50; font-size: 11px;"};var ve=function(e,t,r,o){var i,a=arguments.length,s=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a<3?i(s):a>3?i(t,r,s):i(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};void 0!==ne&&ne.disableWarning&&ne.disableWarning("change-in-update");class ye extends ne{constructor(){super(...arguments),this._consumptionData=[],this._comparisonResult=null,this._tariffCosts=null,this._loading=!1,this._error=null,this._comparisonError=null,this._currentPeriod="week",this._currentDate=new Date,this._weekComparisonData=null}setConfig(e){if(!e)throw new Error("Invalid configuration");this.config=e}getCardSize(){let e=1;return this.config&&!1!==this.config.show_navigation&&(e+=1),this.config&&this.config.show_tariff_comparison&&(e+=1),e}connectedCallback(){super.connectedCallback(),this._validateConfig(),this._currentPeriod=this.config.default_period||"week",this._loadData()}updated(e){super.updated(e),e.has("config")&&(this._validateConfig(),void 0!==e.get("config")&&this._loadData())}_validateConfig(){return this.config?this.config.source_entry_id?(!this.config.show_tariff_comparison||this.config.tariff_entry_ids&&0!==this.config.tariff_entry_ids.length||me.warn("show_tariff_comparison is enabled but no tariff_entry_ids provided. Comparison will be disabled."),void(this.config.show_cost_on_chart&&!this.config.selected_tariff_for_cost&&me.warn("show_cost_on_chart is enabled but selected_tariff_for_cost is not set. Cost display will be disabled."))):(this._error="source_entry_id is required. Please select your tariff from the card editor.",void(this._loading=!1)):(this._error="Card configuration is required",void(this._loading=!1))}_createTimeoutPromise(e){return new Promise((t,r)=>{setTimeout(()=>r(new Error("Request timeout. The service call took too long to respond.")),e)})}async _callServiceWithTimeout(e,t,r,o=!0){me.groupServiceCall(e,t);try{let i;if(me.serviceCall(e,t,o),r&&me.serviceData(r),o&&this.hass.callWS)try{i=await this._callServiceViaWebSocket(e,t,r)}catch(o){const a=o instanceof Error?o.message:String(o);me.warn("⚠ WebSocket call failed, falling back to callService: ",a),i=await this._callServiceViaStandard(e,t,r)}else i=await this._callServiceViaStandard(e,t,r);return me.serviceResponse(i),me.groupEnd(),i}catch(r){throw me.serviceError(r),me.groupEnd(),this._handleServiceError(r,e,t)}}_handleServiceError(e,t,r){if(e instanceof Error)return e.message.includes("timeout")?new Error(`Service call timeout: ${t}.${r} took longer than ${ye.SERVICE_TIMEOUT}ms`):e.message.includes("Service not found")||e.message.includes("not available")?new Error(`Service ${t}.${r} is not available. Please ensure the Octopus Energy España integration is installed and configured.`):"service_validation_error"===e.code?this._handleValidationError(e):new Error(`Service call failed: ${t}.${r} - ${e.message}`);if(e&&"object"==typeof e){const o=e;if("service_validation_error"===o.code)return this._handleValidationError(o);const i=o.message||o.translation_key||"Unknown service error";return new Error(`Service call failed: ${t}.${r} - ${i}`)}return e instanceof Error?e:new Error(String(e))}_handleValidationError(e){const t=(Error,e);let r=t.message||t.translation_key||"Service validation error";return r.includes("return_response")&&(r="The service integration may not support response data yet. Please ensure you're using the latest version of the Octopus Energy España integration and that it has been reloaded after updating."),new Error(`Service validation error: ${r}`)}_validateConsumptionResponse(e){if(!e||"object"!=typeof e)throw me.groupError("Invalid service response"),me.error("✗ Invalid service response: ","expected object with success field"),me.groupEnd(),new Error("Invalid response from service: expected object with success field");if(!("success"in e))throw me.groupError("Invalid service response format"),me.error("✗ Invalid service response format: ","response does not contain success field"),me.data("Received response",e),me.groupEnd(),new Error("Service returned unexpected response format. The service may not be returning data correctly. Please check the integration configuration and ensure the service supports returning response data.")}_extractErrorMessage(e){return e instanceof Error?e.message:e&&"object"==typeof e?e.message||e.translation_key||JSON.stringify(e):String(e)}_createUserFriendlyError(e){if(e instanceof Error)return e;if(e&&"object"==typeof e){const t=e;let r=t.message||t.translation_key||JSON.stringify(e);return"service_validation_error"===t.code&&(r=r.includes("return_response")?"The service integration may not support response data yet. Please ensure you're using the latest version of the Octopus Energy España integration and that it has been reloaded after updating.":r||"Service validation error. Please check your configuration."),new Error(r)}return new Error(String(e))}_extractWebSocketResponse(e){return e&&"object"==typeof e?"service_response"in e?e.service_response:"response"in e?e.response:e:e}async _callServiceViaWebSocket(e,t,r){if(!this.hass.callWS)throw new Error("callWS is not available");const o=this.hass.callWS({type:"call_service",domain:e,service:t,service_data:r,return_response:!0}),i=this._createTimeoutPromise(ye.SERVICE_TIMEOUT),a=await Promise.race([o,i]);return this._extractWebSocketResponse(a)}async _callServiceViaStandard(e,t,r){const o=this.hass.callService(e,t,r),i=this._createTimeoutPromise(ye.SERVICE_TIMEOUT);return await Promise.race([o,i])}async _loadData(){if(!this.hass||!this.config)return;const e=this.config.source_entry_id;if(!e)return this._error="source_entry_id is required. Please select your tariff from the card editor.",void(this._loading=!1);this._loading=!0,this._error=null,this._comparisonError=null;try{const{startDate:t,endDate:r}=this._getDateRange();this._validateDateRange(t,r);const o=`${t.toISOString().split("T")[0]} → ${r.toISOString().split("T")[0]}`;me.groupDataLoad(e,this._currentPeriod,o);const i=await this._fetchConsumptionData(e,t,r);this._consumptionData=i.consumption_data||[],i.tariff_costs?this._tariffCosts=i.tariff_costs:this._tariffCosts=null,this.config.show_tariff_comparison&&this.config.tariff_entry_ids?.length&&await this._fetchTariffComparison(e,t,r),this.config.show_week_comparison?this._weekComparisonData=this._calculateWeekComparison():this._weekComparisonData=null,me.groupEnd()}catch(e){me.groupError("Error loading data"),this._error=e instanceof Error?e.message:String(e),me.error("Error loading data: ",this._extractErrorMessage(e)),me.data("Error details",e),me.groupEnd()}finally{this._loading=!1}}_validateDateRange(e,t){if(e>new Date)throw new Error(`Invalid date range: start date (${e.toISOString().split("T")[0]}) is in the future. Please navigate to a past period.`);if(e>t)throw new Error("Invalid date range: start date is after end date.")}async _fetchConsumptionData(e,t,r){const o="heat-calendar"===this.config.chart_type&&"year"===this.config.heat_calendar_period?"daily":"day"===this._currentPeriod||"week"===this._currentPeriod?"hourly":"daily";let i;try{i=await this._callServiceWithTimeout(ye.SERVICE_DOMAIN,ye.SERVICE_FETCH_CONSUMPTION,{entry_id:e,start_date:t.toISOString().split("T")[0],end_date:r.toISOString().split("T")[0],granularity:o}),me.data("Raw Service Response (before processing)",i);const a=i;return this._validateConsumptionResponse(a),a.success||this._handleConsumptionError(a,e),a}catch(e){throw me.groupError("Service call failed"),me.error("✗ Service call failed: ",this._extractErrorMessage(e)),me.data("Full Error Object",e),me.groupEnd(),this._createUserFriendlyError(e)}}_handleConsumptionError(e,t){const r=e.error||"Failed to fetch consumption data";let o=r;throw e.warning&&(o+=`. ${e.warning}`,me.warn("⚠ Service Warning: ",e.warning)),me.groupError("Service returned error"),me.error("✗ Service returned error: ",r),me.data("Requested Entry ID",t),e.context&&(me.data("Service Context",e.context),e.context.id&&e.context.id!==t&&me.warn("⚠ Note: Service context shows different entry ID (",e.context.id+"). This may be informational.")),me.groupEnd(),me.data("Full Response",{success:e.success,error:e.error,warning:e.warning,context:e.context}),new Error(o)}async _fetchTariffComparison(e,t,r){try{const o="day"===this._currentPeriod?"daily":"week"===this._currentPeriod?"weekly":"monthly",i=await this._callServiceWithTimeout(ye.SERVICE_DOMAIN,ye.SERVICE_COMPARE_TARIFFS,{tariff_entry_ids:this.config.tariff_entry_ids,source_entry_id:e,period:o,start_date:t.toISOString().split("T")[0],end_date:r.toISOString().split("T")[0]});if(i.success&&i.result)this._comparisonResult=i.result;else{const e=i.error||"Failed to compare tariffs";this._comparisonError=e,me.groupError("Tariff comparison failed"),me.warn("⚠ Tariff comparison failed: ",e),me.groupEnd()}}catch(e){const t=e instanceof Error?e.message:String(e);this._comparisonError=`Tariff comparison error: ${t}`,me.groupError("Tariff comparison error"),me.warn("⚠ Tariff comparison error: ",t),me.groupEnd()}}_getDateRange(){if("heat-calendar"===this.config.chart_type&&"year"===this.config.heat_calendar_period){const e=this._currentDate.getFullYear(),t=new Date,r=e===t.getFullYear(),o=new Date(e,0,1);o.setHours(0,0,0,0);const i=r?new Date(t):new Date(e,11,31);return i.setHours(23,59,59,999),{startDate:o,endDate:i}}const e=new Date(this._currentDate);e.setHours(23,59,59,999);const t=new Date(e);return"day"===this._currentPeriod?t.setHours(0,0,0,0):"week"===this._currentPeriod?(t.setDate(t.getDate()-6),t.setHours(0,0,0,0)):"month"===this._currentPeriod&&(t.setDate(t.getDate()-29),t.setHours(0,0,0,0)),{startDate:t,endDate:e}}_navigatePeriod(e){const t="prev"===e?-1:1;if("heat-calendar"===this.config.chart_type&&"year"===this.config.heat_calendar_period)return this._currentDate.setFullYear(this._currentDate.getFullYear()+t),this._currentDate=new Date(this._currentDate),void this._loadData();"day"===this._currentPeriod?this._currentDate.setDate(this._currentDate.getDate()+t):"week"===this._currentPeriod?this._currentDate.setDate(this._currentDate.getDate()+7*t):"month"===this._currentPeriod&&this._currentDate.setMonth(this._currentDate.getMonth()+t),this._currentDate=new Date(this._currentDate),this._loadData()}_setPeriod(e){this._currentPeriod=e,this._loadData()}_extractPeriodData(){if(this._tariffCosts&&this.config.source_entry_id){const e=this._tariffCosts[this.config.source_entry_id];if(e&&e.hourly_breakdown){const t=new Map;for(const r of e.hourly_breakdown){const e=r.hour||"",o=r.consumption||0,i=r.period;t.has(e)||t.set(e,{p1:0,p2:0,p3:0});const a=t.get(e);"P1"===i?a.p1+=o:"P2"===i?a.p2+=o:"P3"===i&&(a.p3+=o)}const r=Array.from(t.entries()).map(([e,t])=>({timestamp:e,...t}));if(r.length>0)return r}if(e&&e.daily_breakdown&&"month"===this._currentPeriod&&e.period_breakdown){const t=e.period_breakdown.p1_percentage/100,r=e.period_breakdown.p2_percentage/100,o=e.period_breakdown.p3_percentage/100;return e.daily_breakdown.map(e=>({timestamp:e.date,p1:e.consumption*t,p2:e.consumption*r,p3:e.consumption*o}))}}if(this._consumptionData.length>0){const e=this._consumptionData[0];if(void 0!==e.p1_consumption||e.period)return this._consumptionData.map(e=>({timestamp:e.start_time||e.date||"",p1:e.p1_consumption||("P1"===e.period?e.consumption:0),p2:e.p2_consumption||("P2"===e.period?e.consumption:0),p3:e.p3_consumption||("P3"===e.period?e.consumption:0)}))}return null}_calculateMovingAverage(e,t){if(t<2||0===e.length)return e.map(()=>null);const r=[];for(let o=0;o<e.length;o++)if(o<t-1)r.push(null);else{let i=0;for(let r=0;r<t;r++)i+=e[o-r];r.push(i/t)}return r}_calculateCostMovingAverage(e,t=30){return this._calculateMovingAverage(e,t)}_renderHeatCalendar(){const e=this._getHeatCalendarData(),t="year"===(this.config.heat_calendar_period||"month");if(0===e.length)return Y`
      ...
      <div class="heat-calendar-container ${t?"heat-calendar-year-view":""}">
        ...
        <div class="heat-calendar-grid ${t?"heat-calendar-grid-year":""}">
          ${["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map(e=>Y`
            <div class="heat-calendar-day empty" style="font-weight: 600;">${e}</div>
          `)}
          ${n.map((e,r)=>{const a=s+r,n=i.get(a),c=t&&void 0!==n&&(0===r||i.get(s+r-1)!==n);return Y`
              ${c?Y`
                <div class="heat-calendar-month-label" style="grid-column: 1 / -1;">
                  ${o[n]}
                </div>
              `:""}
              ${e.map(e=>{if(!e)return Y`<div class="heat-calendar-day empty"></div>`;const r=new Date(e.date),i=r.getDate(),a=o[r.getMonth()],s=t?`${a} ${i}, ${e.year}: ${e.consumption.toFixed(2)} kWh, €${e.cost.toFixed(2)}`:`${e.date}: ${e.consumption.toFixed(2)} kWh, €${e.cost.toFixed(2)}`;return Y`
                  <div 
    ...
    `}_renderWeekComparison(){if(!this._weekComparisonData||0===this._weekComparisonData.weeks.length)return Y`<div class="loading">No week comparison data available</div>`;const{weeks:e,comparisons:t}=this._weekComparisonData;return Y`
      <div class="week-comparison-section">
        <div class="comparison-title">Week-over-Week Comparison</div>
        <div class="week-comparison-grid">
          ${e.map((r,o)=>{const i=t.find(e=>e.weekIndex===o);return Y`
              <div class="week-card">
    ...
    `}_renderTariffComparisonChart(){if(!this._comparisonResult||!this._comparisonResult.tariffs||0===this._comparisonResult.tariffs.length)return Y``;const e=this._comparisonResult.tariffs;let t=0;for(const r of e){const e=r.period_breakdown;t=Math.max(t,e.p1_consumption,e.p2_consumption,e.p3_consumption),e.p1_consumption>0&&r.hourly_breakdown?.filter(e=>"P1"===e.period).reduce((e,t)=>e+t.cost,0),e.p2_consumption>0&&r.hourly_breakdown?.filter(e=>"P2"===e.period).reduce((e,t)=>e+t.cost,0),e.p3_consumption>0&&r.hourly_breakdown?.filter(e=>"P3"===e.period).reduce((e,t)=>e+t.cost,0)}return Y`
    ...
    `}_getISOWeekOfYear(e){const t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),r=t.getUTCDay()||7;t.setUTCDate(t.getUTCDate()+4-r);const o=new Date(Date.UTC(t.getUTCFullYear(),0,1));return Math.ceil(((t.getTime()-o.getTime())/864e5+1)/7)-1}_getHeatCalendarData(){if(!this._tariffCosts||!this.config.source_entry_id)return[];const e=this._tariffCosts[this.config.source_entry_id];if(!e||!e.daily_breakdown||0===e.daily_breakdown.length)return[];const t=this.config.heat_calendar_period||"month";let r=e.daily_breakdown;if("year"===t){const e=this._currentDate.getFullYear();r=r.filter(t=>new Date(t.date).getFullYear()===e)}else{const e=this._currentDate.getFullYear(),t=this._currentDate.getMonth();r=r.filter(r=>{const o=new Date(r.date);return o.getFullYear()===e&&o.getMonth()===t})}if(0===r.length)return[];const o=r.map(e=>e.consumption).filter(e=>e>0);if(0===o.length)return[];const i=[...o].sort((e,t)=>e-t),a=i[Math.floor(.33*i.length)],s=i[Math.floor(.67*i.length)],n=[];for(const e of r){const r=new Date(e.date),o=r.getDay(),i=r.getFullYear(),c=r.getMonth();let l,d;if("year"===t)d=this._getISOWeekOfYear(r);else{const e=new Date(r.getFullYear(),r.getMonth(),1).getDay(),t=r.getDate();l=Math.floor((t+e-1)/7)}let p="medium";e.consumption<=a?p="low":e.consumption>=s&&(p="high"),n.push({date:e.date,consumption:e.consumption,cost:e.cost,dayOfWeek:o,weekOfMonth:l,weekOfYear:d,month:c,year:i,intensity:p})}return n}_calculateWeekComparison(){if(!this._tariffCosts||!this.config.source_entry_id)return null;const e=this._tariffCosts[this.config.source_entry_id];if(!e||!e.daily_breakdown||0===e.daily_breakdown.length)return null;const t=this.config.week_comparison_count||2,r=e.daily_breakdown,o=new Map;for(const t of r){const r=new Date(t.date),i=r.getDay(),a=r.getDate()-i+(0===i?-6:1),s=new Date(r.setDate(a));s.setHours(0,0,0,0);const n=s.toISOString().split("T")[0];if(!o.has(n)){const e=new Date(s);e.setDate(s.getDate()+6),o.set(n,{weekStart:n,weekEnd:e.toISOString().split("T")[0],consumption:0,cost:0,periodBreakdown:{p1_consumption:0,p2_consumption:0,p3_consumption:0}})}const c=o.get(n);if(c.consumption+=t.consumption,c.cost+=t.cost,e.period_breakdown){const r=e.period_breakdown.p1_percentage/100,o=e.period_breakdown.p2_percentage/100,i=e.period_breakdown.p3_percentage/100;c.periodBreakdown.p1_consumption+=t.consumption*r,c.periodBreakdown.p2_consumption+=t.consumption*o,c.periodBreakdown.p3_consumption+=t.consumption*i}}const i=Array.from(o.values()).sort((e,t)=>new Date(t.weekStart).getTime()-new Date(e.weekStart).getTime()),a=i.slice(0,t),s=[];for(let e=0;e<a.length-1;e++){const t=a[e],r=a[e+1],o=t.consumption-r.consumption,i=r.consumption>0?o/r.consumption*100:0,n=t.cost-r.cost,c=r.cost>0?n/r.cost*100:0;s.push({weekIndex:e,consumptionChange:o,consumptionChangePercent:i,costChange:n,costChangePercent:c})}return{weeks:a,comparisons:s}}render(){return this._loading?Y`
      ...
      ${!1!==this.config.show_navigation?Y`
        ...
        <div class="navigation-controls">
          <button class="nav-button" @click=${()=>this._navigatePeriod("prev")}>
            ${"heat-calendar"===this.config.chart_type&&"year"===this.config.heat_calendar_period?"← Previous Year":"← Previous"}
          </button>
          <button class="nav-button" @click=${()=>this._navigatePeriod("next")}>
            ${"heat-calendar"===this.config.chart_type&&"year"===this.config.heat_calendar_period?"Next Year →":"Next →"}
          </button>
        </div>
      `:""}
      ...
      ${this.config.show_tariff_comparison?Y`
      ...
      `:""}
    `}_renderChart(){if(0===this._consumptionData.length)return Y`<div class="loading">No consumption data available</div>`;const e=this.config.chart_type||"line";if("heat-calendar"===e)return this._renderHeatCalendar();const t=this._consumptionData.map(e=>e.consumption||e.value||0),r=Math.max(...t,1),o=Math.min(...t,0),i=r-o||1;let a=[],s=0,n=0,c=1;const l=this.config.show_cost_on_chart&&this.config.selected_tariff_for_cost&&null!==this._tariffCosts;if(l&&this._tariffCosts&&this.config.selected_tariff_for_cost){const e=this._tariffCosts[this.config.selected_tariff_for_cost];if(e){const r="month"===this._currentPeriod?e.daily_breakdown:e.hourly_breakdown;r&&r.length>0?(a=r.map(e=>e.cost),a.length!==t.length?(me.warn(`Cost data length (${a.length}) does not match consumption data length (${t.length}). Cost display disabled.`),a=[]):(s=Math.max(...a,.01),n=Math.min(...a,0),c=s-n||1)):me.warn(`No breakdown data available for tariff ${this.config.selected_tariff_for_cost}. Cost display disabled.`)}else me.warn(`Tariff cost data not found for entry ID: ${this.config.selected_tariff_for_cost}. Cost display disabled.`)}const d=l&&a.length>0&&a.length===t.length,p=800,h=300,_=20,u=d?60:20,f=40,g=60,m=h-_-f,v=(p-g-u)/(t.length-1||1),y=t.map((e,t)=>({x:g+t*v,y:_+m-(e-o)/i*m,value:e})),x=y.length>0?`M ${y[0].x} ${y[0].y} ${y.slice(1).map(e=>`L ${e.x} ${e.y}`).join(" ")}`:"",b=y.length>0?`${x} L ${y[y.length-1].x} ${h-f} L ${y[0].x} ${h-f} Z`:"",w=[];if(!isNaN(i)&&i>0)for(let e=0;e<=5;e++){const t=o+i*e/5,r=_+m-e/5*m;w.push({value:t,y:r})}else me.warn(`Cannot generate Y-axis labels: chartHeight=${m}, range=${i}`);let $=[],k="",C=[];if(d&&a.length>0&&a.length===t.length){$=a.map((e,t)=>({x:g+t*v,y:_+m-(e-n)/c*m,value:e})),$.length>0&&(k=`M ${$[0].x} ${$[0].y} ${$.slice(1).map(e=>`L ${e.x} ${e.y}`).join(" ")}`);for(let e=0;e<=5;e++){const t=n+c*e/5,r=_+m-e/5*m;C.push({value:t,y:r})}}const S=[];if(y.length>0&&this._consumptionData.length>0){const e=this._consumptionData[0],t=this._consumptionData[this._consumptionData.length-1],r=Math.floor(this._consumptionData.length/2),o=this._consumptionData[r],i=e=>{try{return new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch{return e.split("T")[0]}};e&&(e.start_time||e.date)&&S.push({label:i(e.start_time||e.date||""),x:y[0].x}),o&&(o.start_time||o.date)&&S.push({label:i(o.start_time||o.date||""),x:y[r]?.x||y[0].x}),t&&(t.start_time||t.date)&&S.push({label:i(t.start_time||t.date||""),x:y[y.length-1].x})}else me.warn(`Cannot generate X-axis labels: points.length=${y.length}, consumptionData.length=${this._consumptionData.length}`);if("bar"===e)return Y`
        <svg class="chart-svg" viewBox="0 0 ${p} ${h}" preserveAspectRatio="xMidYMid meet">
          ...
          <!-- Bars -->
          ${y.map((e,t)=>{const r=Math.max(.6*v,2),o=e.x-r/2,i=h-f-e.y;return Y`
          ...
          ${w.map(e=>Y`
            <text class="chart-text" x="${g-10}" y="${e.y+4}" text-anchor="end">
      ...
      `;if("stacked-area"===e){const e=this._extractPeriodData();if(!e||0===e.length)return Y`
          <div class="error-message">
        ...
        `;const t=e.map(e=>e.p1||0),r=e.map(e=>e.p2||0),o=e.map(e=>e.p3||0),i=o,a=o.map((e,t)=>e+(r[t]||0)),s=a.map((e,r)=>e+(t[r]||0)),n=Math.max(...s,1),c=0,l=n-c||1,d=(e,t)=>{if(0===e.length)return"";const r=e.map((e,t)=>({x:g+t*v,y:_+m-(e-c)/l*m})),o=t.map((e,t)=>({x:g+t*v,y:_+m-(e-c)/l*m})).reverse(),i=r.map((e,t)=>0===t?`M ${e.x} ${e.y}`:`L ${e.x} ${e.y}`).join(" "),a=o.map(e=>`L ${e.x} ${e.y}`).join(" ");return`${i} ${a} Z`},y=[];for(let e=0;e<=5;e++){const t=c+l*e/5,r=_+m-e/5*m;y.push({value:t,y:r})}const x=d(i,new Array(e.length).fill(0)),b=d(a,i),w=d(s,a);return Y`
        <svg class="chart-svg" viewBox="0 0 ${p} ${h}" preserveAspectRatio="xMidYMid meet">
          <!-- Grid lines -->
          ${y.map(e=>Y`
            <line class="chart-grid-line" 
          ...
          <!-- Y-axis labels -->
          ${y.map(e=>Y`
            <text class="chart-text" x="${g}" y="${e.y+4}" text-anchor="start">
              ${e.value.toFixed(1)} kWh
            </text>
          `)}
      ...
      <svg class="chart-svg" viewBox="0 0 ${p} ${h}" preserveAspectRatio="xMidYMid meet">
        ...
        <!-- Moving average line -->
        ${this.config.show_moving_average&&E?Y`
        ...
        <!-- Legend -->
        ${d||this.config.show_moving_average||this.config.show_cost_trend?Y`
          <g>
            ${d?Y`
            ...
            `:""}
            ${this.config.show_moving_average?Y`
            ...
            `:""}
            ${this.config.show_cost_trend&&P?Y`
    ...
    `}_renderComparison(){if(!this._comparisonResult||!this._comparisonResult.tariffs||0===this._comparisonResult.tariffs.length)return Y`<p>No comparison data available</p>`;const e=[...this._comparisonResult.tariffs].sort((e,t)=>e.total_cost-t.total_cost),t=this._comparisonResult.best_tariff?.entry_id,r=this._comparisonResult.tariffs[0],o=r?.period_breakdown;return Y`
      <!-- Consumption Summary -->
      ${o?Y`
          ...
          <div class="tariff-item">
            <div class="tariff-header">
              <span class="tariff-name">
                ${e.name}
                ${t===e.entry_id?Y`<span class="best-tariff-badge">Best</span>`:""}
              </span>
        ...
        <div class="period-bars">
          <div class="period-bar">
            ...
            <div class="period-bar-label">
              ...
              ${o>0?Y`<span class="cost-per-kwh">€${s.toFixed(3)}/kWh</span>`:""}
            </div>
          </div>
          <div class="period-bar">
            <div
            ...
            <div class="period-bar-label">
              ...
              ${i>0?Y`<span class="cost-per-kwh">€${n.toFixed(3)}/kWh</span>`:""}
            </div>
          </div>
          <div class="period-bar">
            <div
  ...
  `,ve([pe({attribute:!1})],ye.prototype,"hass",void 0),ve([pe({attribute:!1})],ye.prototype,"config",void 0),ve([he()],ye.prototype,"_consumptionData",void 0),ve([he()],ye.prototype,"_comparisonResult",void 0),ve([he()],ye.prototype,"_tariffCosts",void 0),ve([he()],ye.prototype,"_loading",void 0),ve([he()],ye.prototype,"_error",void 0),ve([he()],ye.prototype,"_comparisonError",void 0),ve([he()],ye.prototype,"_currentPeriod",void 0),ve([he()],ye.prototype,"_currentDate",void 0),ve([he()],ye.prototype,"_weekComparisonData",void 0),"undefined"!=typeof window&&(window.getCardElement=xe,window.getCardConfigElement=be,window.getStubConfig=we),"undefined"!=typeof window&&"undefined"!=typeof customElements){try{customElements.get("octopus-consumption-card")||customElements.define("octopus-consumption-card",ye)}catch(e){me.error("Failed to register octopus-consumption-card: ",e instanceof Error?e.message:String(e))}if(void 0===window.customCards&&(window.customCards=[]),Array.isArray(window.customCards)){window.customCards.some(e=>"custom:octopus-consumption-card"===e.type)||window.customCards.push({type:"custom:octopus-consumption-card",name:"Octopus Energy España Consumption Card",preview:!1,description:"Display consumption data and tariff comparisons for Octopus Energy España"})}window.customCards["octopus-consumption-card"]=ye,window.OctopusConsumptionCard=ye;const e="0.5.0",t=!!customElements.get("octopus-consumption-card");console.groupCollapsed("%c⚡ Octopus Energy España","background: linear-gradient(90deg, #e10090 0%, #c000a0 100%);color: #fff;padding: 4px 8px;border-radius: 4px;font-weight: bold;"),me.info("Consumption Card",`v${e}`),me.info(t?"✓ Custom element: ":"✗ Custom element: ","octopus-consumption-card"),me.success("✓ Added to card picker"),me.success("✓ Visual editor enabled"),me.info("ℹ Supported languages: ","en, es, be"),t||me.error("✗ Registration failed! Element not found in customElements registry"),console.groupEnd()}return e.OctopusConsumptionCard=ye,e.getCardConfigElement=be,e.getCardElement=xe,e.getStubConfig=we,e}({});
