...
`;var me=function(e,t,r,o){var i,a=arguments.length,s=a<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var n=e.length-1;n>=0;n--)(i=e[n])&&(s=(a<3?i(s):a>3?i(t,r,s):i(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};void 0!==ne&&ne.disableWarning&&ne.disableWarning("change-in-update");class ve extends ne{constructor(){super(...arguments),this._config={type:"custom:octopus-consumption-card",source_entry_id:"",view:"consumption",default_period:"week",chart_type:"line",tariff_entry_ids:[],show_cost_on_chart:!1,show_navigation:!0,show_period_distribution:!1,show_moving_average:!1,moving_average_days:7},this._language="en",this._computeLabel=e=>function(e,t="en"){return _e(`editor.${e.name}_label`,t)}(e,this._language),this._computeHelper=e=>function(e,t="en"){return _e(`editor.${e.name}_helper`,t)}(e,this._language)}setConfig(e){const t={...e,view:e.view||"consumption"};JSON.stringify(this._config)!==JSON.stringify(t)&&(this._config=t)}willUpdate(e){if(e.has("config")&&this.config){const e={...this.config,view:this.config.view||"consumption"};JSON.stringify(this._config)!==JSON.stringify(e)&&(this._config=e)}if(e.has("hass")&&this.hass){const e=this.hass.language||"en";this._language!==e&&(this._language=e)}}firstUpdated(){if(this.config){const e={...this.config,view:this.config.view||"consumption"};JSON.stringify(this._config)!==JSON.stringify(e)&&(this._config=e)}this.hass&&(this._language=this.hass.language||"en")}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.detail.value;t.view||(t.view="consumption");const r=this._config.view!==t.view;!1===t.show_cost_on_chart&&(t.selected_tariff_for_cost=void 0),!1===t.show_cost_on_chart&&(t.selected_tariff_for_cost=void 0),this._config=t,r&&this.requestUpdate(),this._fireConfigChanged()}_fireConfigChanged(){const e=new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0});this.dispatchEvent(e)}_buildSchema(){const e=this._config.view||"consumption",t=[{name:"view",selector:{select:{mode:"dropdown",options:[{value:"consumption",label:_e("editor.view_consumption",this._language)},{value:"heat-calendar",label:_e("editor.view_heat_calendar",this._language)},{value:"week-analysis",label:_e("editor.view_week_analysis",this._language)},{value:"tariff-comparison",label:_e("editor.view_tariff_comparison",this._language)}]}}},{name:"source_entry_id",required:!0,selector:{config_entry:{integration:"octopus_energy_es"}}}];return"consumption"===e?(t.push({name:"default_period",selector:{select:{mode:"dropdown",options:[{value:"day",label:_e("editor.period_day",this._language)},{value:"week",label:_e("editor.period_week",this._language)},{value:"month",label:_e("editor.period_month",this._language)}]}}},{name:"chart_type",selector:{select:{mode:"dropdown",options:[{value:"line",label:_e("editor.chart_type_line",this._language)},{value:"bar",label:_e("editor.chart_type_bar",this._language)},{value:"stacked-area",label:_e("editor.chart_type_stacked_area",this._language)}]}}},{name:"show_navigation",selector:{boolean:{}}},{name:"show_period_distribution",selector:{boolean:{}}},{name:"show_moving_average",selector:{boolean:{}}}),this._config.show_moving_average&&t.push({name:"moving_average_days",selector:{number:{min:2,max:30,mode:"box"}}}),t.push({name:"show_cost_on_chart",selector:{boolean:{}}}),this._config.show_cost_on_chart&&t.push({name:"selected_tariff_for_cost",selector:{config_entry:{integration:"octopus_energy_es"}}}),t.push({name:"show_cost_trend",selector:{boolean:{}}}),this._config.show_cost_trend&&t.push({name:"cost_moving_average_days",selector:{number:{min:2,max:90,mode:"box"}}})):"heat-calendar"===e?t.push({name:"heat_calendar_period",selector:{select:{mode:"dropdown",options:[{value:"month",label:_e("editor.heat_calendar_period_month",this._language)},{value:"year",label:_e("editor.heat_calendar_period_year",this._language)}]}}},{name:"show_navigation",selector:{boolean:{}}}):"week-analysis"===e?(t.push({name:"show_week_comparison",selector:{boolean:{}}},{name:"show_navigation",selector:{boolean:{}}}),this._config.show_week_comparison&&t.push({name:"week_comparison_count",selector:{number:{min:2,max:8,mode:"box"}}})):"tariff-comparison"===e&&t.push({name:"show_tariff_chart",selector:{boolean:{}}}),t.push({name:"consumption_sensor",selector:{entity:{domain:"sensor"}}}),t}_handleTariffSelection(e,t){const r=t.detail.value;this._config.tariff_entry_ids||(this._config.tariff_entry_ids=[]);const o=[...this._config.tariff_entry_ids];for(;o.length<=e;)o.push("");if(r){const t=o.findIndex((t,o)=>o!==e&&t===r);-1!==t&&(o[t]=""),o[e]=r,this._config.tariff_entry_ids=o.filter((e,t,r)=>e&&r.indexOf(e)===t)}else o.splice(e,1),this._config.tariff_entry_ids=o.filter(e=>e);this.requestUpdate(),this._fireConfigChanged()}_removeTariff(e){if(!this._config.tariff_entry_ids||e>=this._config.tariff_entry_ids.length)return;const t=[...this._config.tariff_entry_ids];t.splice(e,1),this._config.tariff_entry_ids=t.filter(e=>e),this.requestUpdate(),this._fireConfigChanged()}_renderTariffDropdowns(){const e=this._config.tariff_entry_ids||[],t=e.length>0?e.length+1:1;return V`
    ...
    `}_renderChart(){if(0===this._consumptionData.length)return V`<div class="loading">No consumption data available</div>`;const e=this.config.chart_type||"line",t=this._consumptionData.map(e=>e.consumption||e.value||0),r=Math.max(...t,1),o=Math.min(...t,0),i=r-o||1;let a=[],s=0,n=0,c=1;const l=this.config.show_cost_on_chart&&this.config.selected_tariff_for_cost&&null!==this._tariffCosts;if(l&&this._tariffCosts&&this.config.selected_tariff_for_cost){const e=this._tariffCosts[this.config.selected_tariff_for_cost];if(e){const r="month"===this._currentPeriod?e.daily_breakdown:e.hourly_breakdown;r&&r.length>0?(a=r.map(e=>e.cost),a.length!==t.length?(ye.warn(`Cost data length (${a.length}) does not match consumption data length (${t.length}). Cost display disabled.`),a=[]):(s=Math.max(...a,.01),n=Math.min(...a,0),c=s-n||1)):ye.warn(`No breakdown data available for tariff ${this.config.selected_tariff_for_cost}. Cost display disabled.`)}else ye.warn(`Tariff cost data not found for entry ID: ${this.config.selected_tariff_for_cost}. Cost display disabled.`)}const d=l&&a.length>0&&a.length===t.length,p=800,h=300,u=20,_=d?60:20,f=40,g=60,m=p-g-_,v=h-u-f,y=80,x=m/(t.length-1||1),w=t.map((e,t)=>({x:g+y+t*x,y:u+v-(e-o)/i*v,value:e})),b=w.length>0?`M ${w[0].x} ${w[0].y} ${w.slice(1).map(e=>`L ${e.x} ${e.y}`).join(" ")}`:"",$=w.length>0?`${b} L ${w[w.length-1].x} ${h-f} L ${w[0].x} ${h-f} Z`:"",k=[];if(!isNaN(i)&&i>0)for(let e=0;e<=5;e++){const t=o+i*e/5,r=u+v-e/5*v;k.push({value:t,y:r})}else ye.warn(`Cannot generate Y-axis labels: chartHeight=${v}, range=${i}`);let C=[],S="",E=[];if(d&&a.length>0&&a.length===t.length){C=a.map((e,t)=>({x:g+y+t*x,y:u+v-(e-n)/c*v,value:e})),C.length>0&&(S=`M ${C[0].x} ${C[0].y} ${C.slice(1).map(e=>`L ${e.x} ${e.y}`).join(" ")}`);for(let e=0;e<=5;e++){const t=n+c*e/5,r=u+v-e/5*v;E.push({value:t,y:r})}}const P=[];if(w.length>0&&this._consumptionData.length>0){const e=this._consumptionData[0],t=this._consumptionData[this._consumptionData.length-1],r=Math.floor(this._consumptionData.length/2),o=this._consumptionData[r],i=e=>{try{return new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch{return e.split("T")[0]}};e&&(e.start_time||e.date)&&P.push({label:i(e.start_time||e.date||""),x:w[0].x}),o&&(o.start_time||o.date)&&P.push({label:i(o.start_time||o.date||""),x:w[r]?.x||w[0].x}),t&&(t.start_time||t.date)&&P.push({label:i(t.start_time||t.date||""),x:w[w.length-1].x})}else ye.warn(`Cannot generate X-axis labels: points.length=${w.length}, consumptionData.length=${this._consumptionData.length}`);if("bar"===e)return V`
        <svg class="chart-svg" viewBox="0 0 ${880} ${340}" preserveAspectRatio="xMidYMid meet">
          ...
          <!-- Bars -->
          ${w.map((e,t)=>{const r=Math.max(.6*x,2),o=e.x-r/2,i=h-f,a=e.y,s=Math.max(i-a,0);return V`
          ...
          ${d?E.map(e=>V`
            <text class="chart-text chart-text-cost" x="${p-_+y+10}" y="${e.y+4}" text-anchor="start" style="font-size: 12px;">
              €${e.value.toFixed(2)}
            </text>
          `):""}
          ...
          ${d&&S?V`
            <path class="chart-line-cost" d="${S}"/>
            ${C.map(e=>V`
              <circle 
                cx="${e.x}" 
                cy="${e.y}" 
          ...
          ${d?V`
            <g>
              ...
              <text x="${p-_+y-80}" y="${u+14}" class="chart-text chart-text-axis-y" font-size="11px">Consumption</text>
              <line x1="${p-_+y-100}" y1="${u+25}" x2="${p-_+y-85}" y2="${u+25}" 
                stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-dasharray="5,5"/>
              <text x="${p-_+y-75}" y="${u+29}" class="chart-text chart-text-cost" font-size="11px">Cost</text>
            </g>
          `:""}
        </svg>
      `;if("stacked-area"===e){const e=this._extractPeriodData();if(!e||0===e.length)return V`
        ...
        `;const t=e.map(e=>e.p1||0),r=e.map(e=>e.p2||0),o=e.map(e=>e.p3||0),i=o,a=o.map((e,t)=>e+(r[t]||0)),s=a.map((e,r)=>e+(t[r]||0)),n=Math.max(...s,1),c=0,l=n-c||1,d=m/(e.length-1||1),x=(e,t)=>{if(0===e.length)return"";const r=e.map((e,t)=>({x:g+y+t*d,y:u+v-(e-c)/l*v})),o=t.map((e,t)=>({x:g+y+t*d,y:u+v-(e-c)/l*v})).reverse(),i=r.map((e,t)=>0===t?`M ${e.x} ${e.y}`:`L ${e.x} ${e.y}`).join(" "),a=o.map(e=>`L ${e.x} ${e.y}`).join(" ");return`${i} ${a} Z`},w=[];for(let e=0;e<=5;e++){const t=c+l*e/5,r=u+v-e/5*v;w.push({value:t,y:r})}const b=x(i,new Array(e.length).fill(0)),$=x(a,i),k=x(s,a),C=[];if(e.length>0){const t=e[0],r=e[e.length-1],o=Math.floor(e.length/2),i=e[o],a=e=>{try{return new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch{return e.split("T")[0]}};if(t&&t.timestamp){const e=g+y;C.push({label:a(t.timestamp),x:e})}if(i&&i.timestamp){const e=g+y+o*d;C.push({label:a(i.timestamp),x:e})}if(r&&r.timestamp){const t=g+y+(e.length-1)*d;C.push({label:a(r.timestamp),x:t})}}return V`
        <svg class="chart-svg" viewBox="0 0 ${880} ${340}" preserveAspectRatio="xMidYMid meet">
          <!-- Grid lines -->
          ${w.map(e=>V`
            <line class="chart-grid-line" 
          ...
          <path class="chart-area-p3" d="${b}"/>
          <path class="chart-area-p2" d="${$}"/>
          <path class="chart-area-p1" d="${k}"/>
          ...
          <g>
            ...
            <text x="${g+y+28}" y="${u+15}" class="chart-text chart-text-axis-y" font-size="11px">P1 (Peak)</text>
            
            <rect x="${g+y+100}" y="${u+5}" width="12" height="12" 
              fill="var(--warning-color, #ff9800)" opacity="0.6"/>
            <text x="${g+y+118}" y="${u+15}" class="chart-text chart-text-axis-y" font-size="11px">P2 (Flat)</text>
            
            <rect x="${g+y+190}" y="${u+5}" width="12" height="12" 
              fill="var(--success-color, #4caf50)" opacity="0.6"/>
            <text x="${g+y+208}" y="${u+15}" class="chart-text chart-text-axis-y" font-size="11px">P3 (Valley)</text>
          </g>
        </svg>
      `}let A="";if(this.config.show_moving_average){const e=this.config.moving_average_days||7,r=this._calculateMovingAverage(t,e).map((e,t)=>{if(null===e)return null;return{x:g+y+t*x,y:u+v-(e-o)/i*v,value:e}}).filter(e=>null!==e);r.length>0&&(A=`M ${r[0].x} ${r[0].y} ${r.slice(1).map(e=>`L ${e.x} ${e.y}`).join(" ")}`)}let D="";if(this.config.show_cost_trend&&d&&a.length>0){const e=this.config.cost_moving_average_days||30,t=this._calculateCostMovingAverage(a,e).map((e,t)=>{if(null===e)return null;return{x:g+y+t*x,y:u+v-(e-n)/c*v,value:e}}).filter(e=>null!==e);t.length>0&&(D=`M ${t[0].x} ${t[0].y} ${t.slice(1).map(e=>`L ${e.x} ${e.y}`).join(" ")}`)}return V`
      <svg class="chart-svg" viewBox="0 0 ${880} ${340}" preserveAspectRatio="xMidYMid meet">
        <!-- Grid lines -->
        ${k.map(e=>V`
          <line class="chart-grid-line" 
        ...
        <!-- Line -->
        <path class="chart-line" d="${b}"/>
        
        <!-- Moving average line -->
        ${this.config.show_moving_average&&A?V`
          <path class="chart-line-moving-avg" d="${A}"/>
        `:""}
          ...
          <g>
            ${d?V`
              <rect x="${p-_+y-120}" y="${u+5}" width="15" height="10" 
                fill="var(--primary-color, #03a9f4)" opacity="0.7"/>
              <text x="${p-_+y-100}" y="${u+14}" class="chart-text chart-text-axis-y" font-size="11px">Consumption</text>
              <line x1="${p-_+y-120}" y1="${u+25}" x2="${p-_+y-105}" y2="${u+25}" 
                stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-dasharray="5,5"/>
              <text x="${p-_+y-95}" y="${u+29}" class="chart-text chart-text-cost" font-size="11px">Cost</text>
            `:""}
            ${this.config.show_moving_average?V`
              ...
              <text x="${g+y+30}" y="${u+14}" class="chart-text chart-text-info" font-size="11px">
                ${this.config.moving_average_days||7}-day avg
              </text>
            `:""}
            ${this.config.show_cost_trend&&D?V`
              <line x1="${g+y+10}" y1="${u+30}" x2="${g+y+25}" y2="${u+30}" 
                stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-dasharray="3,3" opacity="0.7"/>
              <text x="${g+y+30}" y="${u+34}" class="chart-text chart-text-cost" font-size="11px">
    ...
    `}static getStubConfig(){return{type:"custom:octopus-consumption-card",source_entry_id:"",view:"consumption",default_period:"week",chart_type:"line",tariff_entry_ids:[],show_cost_on_chart:!1,show_navigation:!0,show_period_distribution:!1,show_moving_average:!1,moving_average_days:7,heat_calendar_period:"month",show_week_comparison:!1,week_comparison_count:2,show_cost_trend:!1,cost_moving_average_days:30,show_tariff_chart:!0}}static getConfigElement(){return document.createElement("octopus-consumption-card-editor")}}function be(){return we}function $e(){return ve}function ke(){return we.getStubConfig()}if(we.enabledWarnings=[],we.SERVICE_TIMEOUT=1e4,we.SERVICE_DOMAIN="octopus_energy_es",we.SERVICE_FETCH_CONSUMPTION="fetch_consumption",we.SERVICE_COMPARE_TARIFFS="compare_tariffs",we.styles=fe,xe([pe({attribute:!1})],we.prototype,"hass",void 0),xe([pe({attribute:!1})],we.prototype,"config",void 0),xe([he()],we.prototype,"_consumptionData",void 0),xe([he()],we.prototype,"_comparisonResult",void 0),xe([he()],we.prototype,"_tariffCosts",void 0),xe([he()],we.prototype,"_loading",void 0),xe([he()],we.prototype,"_error",void 0),xe([he()],we.prototype,"_comparisonError",void 0),xe([he()],we.prototype,"_currentPeriod",void 0),xe([he()],we.prototype,"_currentDate",void 0),xe([he()],we.prototype,"_weekComparisonData",void 0),"undefined"!=typeof window&&(window.getCardElement=be,window.getCardConfigElement=$e,window.getStubConfig=ke),"undefined"!=typeof window&&"undefined"!=typeof customElements){try{customElements.get("octopus-consumption-card")||customElements.define("octopus-consumption-card",we)}catch(e){ye.error("Failed to register octopus-consumption-card: ",e instanceof Error?e.message:String(e))}if(void 0===window.customCards&&(window.customCards=[]),Array.isArray(window.customCards)){window.customCards.some(e=>"custom:octopus-consumption-card"===e.type)||window.customCards.push({type:"custom:octopus-consumption-card",name:"Octopus Energy España Consumption Card",preview:!1,description:"Display consumption data and tariff comparisons for Octopus Energy España"})}window.customCards["octopus-consumption-card"]=we,window.OctopusConsumptionCard=we;const e="0.5.8",t=!!customElements.get("octopus-consumption-card");console.groupCollapsed("%c⚡ Octopus Energy España","background: linear-gradient(90deg, #e10090 0%, #c000a0 100%);color: #fff;padding: 4px 8px;border-radius: 4px;font-weight: bold;"),ye.info("Consumption Card",`v${e}`),ye.info(t?"✓ Custom element: ":"✗ Custom element: ","octopus-consumption-card"),ye.success("✓ Added to card picker"),ye.success("✓ Visual editor enabled"),ye.info("ℹ Supported languages: ","en, es, be"),t||ye.error("✗ Registration failed! Element not found in customElements registry"),console.groupEnd()}return e.OctopusConsumptionCard=we,e.getCardConfigElement=$e,e.getCardElement=be,e.getStubConfig=ke,e}({});
